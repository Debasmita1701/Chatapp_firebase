  ...
  Widget build(BuildContext context) {
    ...
    //  ),
     ...
     child: Column(
      ...
      children:<Widget> [ const Text("Groupie",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold),),const SizedBox(height: 10,),const Text("Login Now To see what they taking!",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w400),),
